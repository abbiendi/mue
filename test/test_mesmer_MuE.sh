...
g++ ${OPTIONS} -o ${MAIN}.exe -I${src} -I${ROOTINCDIR} ${src}/${MAIN}.cc MuEtreeDict.C ${src}/MuEtree.cc ${src}/Inputs.cc ${src}/Analysis.cc ${src}/FastSim.cc ${src}/Utils.cc ${src}/ElasticState.cc ${src}/Histos.cc ${src}/dalpha.cc ${ROOTLIBS} -L${gen} -lmesmerfull -lgfortran -lX11
